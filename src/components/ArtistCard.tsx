  ...
  return(
    <Card onClick={handleClick} className="w-45 h-55 rounded-lg shadow-lg shadow-gray-500/10" placeholder={undefined} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
      <CardBody className="px-6 text-center" placeholder={undefined} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        ...
        <Typography variant="h5" className="text-lg font-semibold text-gray-600 mb-1 " color="blue-gray" placeholder={undefined} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          {artist.name}
        </Typography>
        <Typography className="text-sm text-gray-400" placeholder={undefined} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          {artist.bio}
        </Typography>
      </CardBody>
    </Card>
